...
const translations = {
    en: { // Default Language
        ...
        demo_link_other: "Other Platform",
        demo_outro: "Immerse yourself in the twisted world and experience the suspense...",
        staff_title: "Meet the Staff",
        staff_world_intro: "Enter a world reflected in a broken looking glass, where logic bends and familiar faces hide unsettling truths. The 'Staff' are the permanent residents, each bound by their own distorted reality.",
        staff_char1_name: "The Clockmaker",
        staff_char1_desc: "Obsessed with time, yet perpetually late. His clocks tick backwards, counting down to an unknown event.",
        staff_char2_name: "The Tea Hostess",
        staff_char2_desc: "Offers tea that tastes like forgotten memories. Her smile never quite reaches her vacant eyes.",
        staff_char3_name: "The Gardener",
        staff_char3_desc: "Tends to roses that weep blood and whisper secrets only the lost can hear.",
        staff_char4_name: "The Cheshire Cat(?)",
        staff_char4_desc: "A flickering grin in the shadows. Offers cryptic advice that leads deeper into confusion.",
        staff_char5_name: "The Card Soldier",
        staff_char5_desc: "Follows orders without question, painting white roses red with something other than paint.",
        staff_char6_name: "The Queen of Hearts",
        staff_char6_desc: "Her rage is the law. Her deck is stacked, and losing means losing your head... or worse.",
        about_title: "About the Developer",
        about_p1: "I am Developer Name / Studio, an independent developer passionate about creating immersive and unsettling experiences.",
        about_p2: "My goal with Game Title is to explore the darkest corners of the human psyche, wrapped in a surreal aesthetic inspired by classic tales, but with a macabre twist.",
        ...
        faq_a_platforms: "A: The initial release is planned for PC (Steam). We are exploring the possibility of bringing it to consoles in the future.",
        ...
        faq_q_langs: "Q: Will the game support specific languages?",
        faq_a_langs: "A: The game will launch in initial languages. We are considering adding more languages post-launch based on community interest.",
        ...
        contact_intro: "Do you have questions, comments, or suggestions? Contact us!",
        contact_label_name: "Name:",
        contact_label_email: "Email:",
        contact_label_message: "Message:",
        contact_button_send: "Send",
        contact_feedback_success: "Message sent successfully (simulation). Thank you!",
        contact_feedback_error: "Error sending message (simulation). Please try again.",
        donations_title: "Support Us / Donations",
        donations_intro: "Independent game development requires a lot of effort and dedication. If you enjoy our work and want to support the creation of Game Title and future projects, consider making a donation. Every contribution helps!",
        donations_popular_platforms: "Popular Platforms",
        donations_paypal: "Donate with PayPal",
        donations_patreon: "Support on Patreon",
        donations_kofi: "Buy Me a Coffee (Ko-fi)",
        donations_direct_title: "Direct Donation (Recommended)",
        donations_direct_intro: "This is the most direct way to support, ensuring that most of your contribution goes towards development without intermediaries.",
        donations_direct_button: "Make a Direct Donation",
    ...
    es: {
        ...
        nav_about: "Sobre Mí",
        nav_faq: "FAQ",
        nav_rabbit_hole: "Agujero Conejo",
        nav_contact: "Contacto",
        nav_donations: "Donaciones",
        lang_select_label: "Idioma:",
        main_game_title: "Título del Juego",
        buy_button: "Comprar Ahora",
        concept_art_title: "Arte Conceptual",
        ...
        demo_link_other: "Otra Plataforma",
        demo_outro: "Sumérgete en el retorcido mundo y experimenta el suspense...",
        staff_title: "Conoce al Staff",
        staff_world_intro: "Entra en un mundo reflejado en un espejo roto, donde la lógica se dobla y rostros familiares esconden verdades inquietantes. El 'Staff' son los residentes permanentes, cada uno atado por su propia realidad distorsionada.",
        staff_char1_name: "El Relojero",
        staff_char1_desc: "Obsesionado con el tiempo, pero perpetuamente tarde. Sus relojes hacen tic-tac hacia atrás, contando hacia un evento desconocido.",
        staff_char2_name: "La Anfitriona del Té",
        staff_char2_desc: "Ofrece té que sabe a recuerdos olvidados. Su sonrisa nunca llega del todo a sus ojos vacíos.",
        staff_char3_name: "El Jardinero",
        staff_char3_desc: "Cuida rosas que lloran sangre y susurran secretos que solo los perdidos pueden oír.",
        staff_char4_name: "El Gato de Cheshire(?)",
        staff_char4_desc: "Una sonrisa parpadeante en las sombras. Ofrece consejos crípticos que llevan más profundo en la confusión.",
        staff_char5_name: "El Soldado de Carta",
        staff_char5_desc: "Sigue órdenes sin preguntar, pintando rosas blancas de rojo con algo más que pintura.",
        staff_char6_name: "La Reina de Corazones",
        staff_char6_desc: "Su furia es la ley. Su baraja está trucada, y perder significa perder la cabeza... o algo peor.",
        about_title: "Sobre el Desarrollador",
        about_p1: "Soy Nombre Desarrollador / Estudio, un desarrollador independiente apasionado por crear experiencias inmersivas y perturbadoras.",
        about_p2: "Mi objetivo con Título del Juego es explorar los rincones más oscuros de la psique humana, envuelto en una estética surrealista inspirada en los cuentos clásicos, pero con un giro macabro.",
        ...
        faq_a_platforms: "R: El lanzamiento inicial está planeado para PC (Steam). Estamos explorando la posibilidad de llevarlo a consolas en el futuro.",
        ...
        faq_q_langs: "P: ¿El juego tendrá soporte para idiomas específicos?",
        faq_a_langs: "R: El juego se lanzará en idiomas iniciales. Estamos considerando añadir más idiomas post-lanzamiento basados en el interés de la comunidad.",
        ...
        contact_intro: "¿Tienes preguntas, comentarios o propuestas? ¡Contáctame!",
        contact_label_name: "Nombre:",
        contact_label_email: "Email:",
        contact_label_message: "Mensaje:",
        contact_button_send: "Enviar Mensaje",
        contact_feedback_success: "Mensaje enviado con éxito (simulación). ¡Gracias!",
        contact_feedback_error: "Error al enviar mensaje (simulación). Por favor, inténtalo de nuevo.",
        donations_title: "Apóyanos / Donaciones",
        donations_intro: "El desarrollo de juegos independientes requiere mucho esfuerzo y dedicación. Si disfrutas de mi trabajo y quieres apoyar la creación de Título del Juego y futuros proyectos, considera hacer una donación. ¡Cada contribución ayuda enormemente!",
        donations_popular_platforms: "Plataformas Populares",
        donations_paypal: "Donar con PayPal",
        donations_patreon: "Apoyar en Patreon",
        donations_kofi: "Invítame un Café (Ko-fi)",
        donations_direct_title: "Donación Directa (Recomendado)",
        donations_direct_intro: "Esta es la forma más directa de apoyar, asegurando que la mayor parte de tu contribución llegue al desarrollo sin intermediarios.",
        donations_direct_button: "Realizar Donación Directa",
    ...
    ja: { // Placeholders
        ...
        nav_about: "開発者について",
        nav_faq: "よくある質問",
        nav_rabbit_hole: "ウサギの穴",
        nav_contact: "連絡先",
        nav_donations: "寄付",
        lang_select_label: "言語:",
        main_game_title: "ゲームタイトル",
        buy_button: "今すぐ購入",
        ...
        demo_link_other: "他のプラットフォーム",
        demo_outro: "歪んだ世界に没入し、サスペンスを体験してください...",
        staff_title: "スタッフ紹介",
        staff_world_intro: "壊れた鏡に映る世界へようこそ。そこでは論理が曲がり、見慣れた顔が不穏な真実を隠しています。「スタッフ」は永住者であり、それぞれが独自の歪んだ現実に縛られています。",
        staff_char1_name: "時計職人",
        staff_char1_desc: "時間に執着しているが、常に遅刻している。彼の時計は逆さまに刻み、未知のイベントへのカウントダウンをしている。",
        staff_char2_name: "ティーホステス",
        staff_char2_desc: "忘れられた記憶の味がするお茶を提供する。彼女の笑顔は、空虚な目に決して届かない。",
        staff_char3_name: "庭師",
        staff_char3_desc: "血を流し、失われた者だけが聞くことができる秘密をささやくバラの世話をする。",
        staff_char4_name: "チェシャ猫(?)",
        staff_char4_desc: "影の中でちらつく笑顔。混乱を深める不可解なアドバイスを提供する。",
        staff_char5_name: "カード兵士",
        staff_char5_desc: "疑問を抱かずに命令に従い、白いバラをペンキ以外の何かで赤く塗る。",
        staff_char6_name: "ハートの女王",
        staff_char6_desc: "彼女の怒りが法律だ。彼女のデッキは積み重ねられており、負けることは頭を失うこと…あるいはそれ以上のことを意味する。",
        about_title: "開発者について",
        about_p1: "私は開発者名 / スタジオ、没入型で不安な体験を作ることに情熱を燃やす独立系開発者です。",
        about_p2: "ゲームタイトルでの私の目標は、古典的な物語に触発されたシュールな美学に包まれ、しかし不気味なひねりを加えた、人間の精神の最も暗い隅を探求することです。",
        ...
        faq_a_platforms: "A: 初期リリースはPC（Steam）で計画されています。将来的にはコンソールへの移植の可能性を探っています。",
        faq_q_release: "Q: 推定リリース日はいつですか？",
        faq_a_release: "A: 現在、鋭意開発中です。推定日は近日公開です。最新情報については、私たちのネットワークをフォローしてください！",
        faq_q_langs: "Q: ゲームは特定の言語をサポートしますか？",
        faq_a_langs: "A: ゲームは初期言語でリリースされます。コミュニティの関心に基づいて、リリース後に追加の言語を追加することを検討しています。",
        ...
        contact_title: "連絡先",
        contact_intro: "質問、コメント、提案がありますか？私に連絡してください！",
        contact_label_name: "名前:",
        contact_label_email: "Eメール:",
        contact_label_message: "メッセージ:",
        contact_button_send: "メッセージを送信",
        contact_feedback_success: "メッセージは正常に送信されました（シミュレーション）。ありがとうございます！",
        contact_feedback_error: "メッセージの送信中にエラーが発生しました（シミュレーション）。もう一度お試しください。",
        donations_title: "サポート/寄付",
        donations_intro: "独立系ゲーム開発には多くの努力と献身が必要です。私の作品を楽しんで、ゲームタイトルや将来のプロジェクトの作成をサポートしたい場合は、寄付をご検討ください。すべての貢献が非常に役立ちます！",
        donations_popular_platforms: "人気のプラットフォーム",
        donations_paypal: "PayPalで寄付",
        donations_patreon: "Patreonでサポート",
        donations_kofi: "コーヒーをおごる (Ko-fi)",
        donations_direct_title: "直接寄付（推奨）",
        donations_direct_intro: "これはサポートする最も直接的な方法であり、貢献の大部分が仲介者なしで開発に確実に届くようにします。",
    ...
    ru: { // Placeholders
        ...
        nav_about: "Обо мне",
        nav_faq: "ЧАВО",
        nav_rabbit_hole: "Кроличья нора",
        nav_contact: "Контакт",
        nav_donations: "Пожертвования",
        lang_select_label: "Язык:",
        main_game_title: "Название Игры",
        ...
        demo_link_other: "Другая Платформа",
        demo_outro: "Погрузитесь в искаженный мир и испытайте напряжение...",
        staff_title: "Знакомьтесь с персоналом",
        staff_world_intro: "Войдите в мир, отраженный в разбитом зеркале, где логика изгибается, а знакомые лица скрывают тревожные истины. «Персонал» - это постоянные жители, каждый из которых связан своей искаженной реальностью.",
        staff_char1_name: "Часовщик",
        staff_char1_desc: "Одержим временем, но вечно опаздывает. Его часы тикают назад, отсчитывая время до неизвестного события.",
        staff_char2_name: "Хозяйка Чаепития",
        staff_char2_desc: "Предлагает чай со вкусом забытых воспоминаний. Ее улыбка никогда не достигает пустых глаз.",
        staff_char3_name: "Садовник",
        staff_char3_desc: "Ухаживает за розами, которые плачут кровью и шепчут секреты, которые могут услышать только потерянные.",
        staff_char4_name: "Чеширский Кот(?)",
        staff_char4_desc: "Мерцающая ухмылка в тени. Дает загадочные советы, которые ведут глубже в замешательство.",
        staff_char5_name: "Карточный Солдат",
        staff_char5_desc: "Беспрекословно выполняет приказы, окрашивая белые розы в красный цвет чем-то иным, кроме краски.",
        staff_char6_name: "Червонная Королева",
        staff_char6_desc: "Ее гнев - закон. Ее колода подтасована, и проигрыш означает потерю головы... или хуже.",
        about_title: "О разработчике",
        about_p1: "Я Имя Разработчика / Студия, независимый разработчик, увлеченный созданием захватывающих и тревожных впечатлений.",
        about_p2: "Моя цель в Название Игры - исследовать самые темные уголки человеческой психики, обернутые в сюрреалистическую эстетику, вдохновленную классическими сказками, но с жутким поворотом.",
        ...
        faq_a_platforms: "О: Первоначальный выпуск запланирован для ПК (Steam). Мы изучаем возможность переноса на консоли в будущем.",
        ...
        faq_q_langs: "В: Будет ли игра поддерживать определенные языки?",
        faq_a_langs: "О: Игра будет выпущена на начальных языках. Мы рассматриваем возможность добавления дополнительных языков после запуска на основе интереса сообщества.",
        ...
        contact_intro: "Есть вопросы, комментарии или предложения? Свяжитесь со мной!",
        contact_label_name: "Имя:",
        contact_label_email: "Email:",
        contact_label_message: "Сообщение:",
        contact_button_send: "Отправить сообщение",
        contact_feedback_success: "Сообщение успешно отправлено (симуляция). Спасибо!",
        contact_feedback_error: "Ошибка при отправке сообщения (симуляция). Пожалуйста, попробуйте еще раз.",
        donations_title: "Поддержите нас / Пожертвования",
        donations_intro: "Разработка независимых игр требует много усилий и самоотдачи. Если вам нравится моя работа и вы хотите поддержать создание Название Игры и будущих проектов, пожалуйста, рассмотрите возможность пожертвования. Каждый вклад очень помогает!",
        donations_popular_platforms: "Популярные платформы",
        donations_paypal: "Пожертвовать через PayPal",
        donations_patreon: "Поддержать на Patreon",
        donations_kofi: "Купить мне кофе (Ko-fi)",
        donations_direct_title: "Прямое пожертвование (Рекомендуется)",
        donations_direct_intro: "Это самый прямой способ поддержки, гарантирующий, что большая часть вашего вклада пойдет на разработку без посредников.",
...
function setLanguage(lang) {
    ...
    document.querySelectorAll('[data-translate-key]').forEach(element => {
        ...
        if (translation) {
            if (key === 'copyright') { element.innerHTML = translation; } else { element.textContent = translation; }
        }
    });
