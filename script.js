// --- Translations ---
    const translations = {
      en: { // Default Language
        ...
        contact_title: "Contact", contact_intro: "Have questions, comments, or proposals? Contact me!", contact_label_name: "Name:", contact_label_email: "Email:", contact_label_message: "Message:", contact_button_send: "Send Message", contact_feedback_success: "Message sent successfully (simulation). Thank you!", contact_feedback_error: "Error sending message (simulation). Please try again.",
        donations_title: "Support Us / Donations", donations_intro: "Independent game development requires a lot of effort and dedication. If you enjoy my work and want to support the creation of Game Title and future projects, please consider making a donation. Every contribution helps immensely!", donations_popular_platforms: "Popular Platforms", donations_paypal: "Donate with PayPal", donations_patreon: "Support on Patreon", donations_kofi: "Buy Me a Coffee (Ko-fi)", donations_direct_title: "Direct Donation (Recommended)", donations_direct_intro: "This is the most direct way to support, ensuring that most of your contribution goes towards development without intermediaries.", donations_direct_button: "Make a Direct Donation",
